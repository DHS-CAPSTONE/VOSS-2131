...
ArcPIDControllerBuilder::ArcPIDControllerBuilder(std::shared_ptr<localizer::AbstractLocalizer> l)
    : ctrl(std::move(l))
{
  this->ctrl.p = nullptr;
}
...
ArcPIDControllerBuilder& ArcPIDControllerBuilder::with_linear_constants(
...
ArcPIDControllerBuilder& ArcPIDControllerBuilder::with_angular_constants(
    double kP, double kI, double kD)
{
