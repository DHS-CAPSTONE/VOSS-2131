...
SwingControllerBuilder::SwingControllerBuilder(std::shared_ptr<localizer::AbstractLocalizer> l)
    : ctrl(std::move(l))
{
  this->ctrl.p = nullptr;
}
...
SwingControllerBuilder& SwingControllerBuilder::with_angular_constants(
