...
PIDControllerBuilder::PIDControllerBuilder(std::shared_ptr<localizer::AbstractLocalizer> l)
    : ctrl(std::move(l))
{
  this->ctrl.p = nullptr;
}
...
PIDControllerBuilder& PIDControllerBuilder::with_linear_constants(double kP, double kI, double kD)
{
  this->ctrl.linear_pid.set_constants(kP, kI, kD);
  return *this;
}

PIDControllerBuilder& PIDControllerBuilder::with_angular_constants(double kP, double kI, double kD)
{
...
PIDControllerBuilder& PIDControllerBuilder::with_min_vel_for_thru(double min_vel)
{
