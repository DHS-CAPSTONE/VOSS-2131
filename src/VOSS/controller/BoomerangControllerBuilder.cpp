...
BoomerangControllerBuilder BoomerangControllerBuilder::from(BoomerangController bmr)
{
...
BoomerangControllerBuilder& BoomerangControllerBuilder::with_linear_constants(
...
BoomerangControllerBuilder& BoomerangControllerBuilder::with_angular_constants(
    double kP, double kI, double kD)
{
...
BoomerangControllerBuilder& BoomerangControllerBuilder::with_min_error(double error)
{
  this->ctrl.min_error = error;
  return *this;
}

BoomerangControllerBuilder& BoomerangControllerBuilder::with_lead_pct(double lead_pct)
{
  this->ctrl.lead_pct = lead_pct;
  return *this;
}

BoomerangControllerBuilder& BoomerangControllerBuilder::with_min_vel_for_thru(double min_vel)
{
