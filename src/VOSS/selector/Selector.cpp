...
void init(int default_auton, const char** autons)
{
  ...
  //       lv_disp_get_default(), lv_color_hex(0xCFB53B), lv_color_hex(0xCFB53B), true,
  //       LV_FONT_DEFAULT);
  ...
  //   lv_obj_set_style_bg_color(blueBtnm, lv_color_hex(0x2196F3), LV_PART_ITEMS |
  //   LV_STATE_CHECKED); lv_obj_set_style_border_width(blueBtnm, 3, LV_PART_ITEMS |
  //   LV_STATE_CHECKED); lv_obj_set_style_border_color(blueBtnm, lv_color_white(), LV_PART_ITEMS |
  //   LV_STATE_CHECKED); lv_obj_set_style_bg_color(blueBtnm, lv_color_hex(0x0D47A1),
  //   LV_PART_ITEMS);
  ...
  //   lv_obj_set_style_bg_color(skillsBtnm, lv_color_hex(0xFFEB38), LV_PART_ITEMS |
  //   LV_STATE_CHECKED); lv_obj_set_style_border_width(skillsBtnm, 3, LV_PART_ITEMS |
  //   LV_STATE_CHECKED); lv_obj_set_style_border_color(skillsBtnm, lv_color_white(), LV_PART_ITEMS
  //   | LV_STATE_CHECKED); lv_obj_set_style_bg_color(skillsBtnm, lv_color_hex(0xF57F17),
  //   LV_PART_ITEMS);
