...
std::shared_ptr<voss::localizer::IMELocalizer> odom = voss::localizer::IMELocalizerBuilder::new_builder()
...
std::shared_ptr<voss::controller::PIDController> pid = voss::controller::PIDControllerBuilder::new_builder(odom)
...
std::shared_ptr<voss::controller::BoomerangController> boomerang = voss::controller::BoomerangControllerBuilder::new_builder(odom)
                     .with_linear_constants(8, 0, 70)
                     .with_angular_constants(250, 0.001, 2500)
                     .with_lead_pct(0.6)
...
std::shared_ptr<voss::controller::SwingController> swing = voss::controller::SwingControllerBuilder::new_builder(odom)
                 .with_angular_constants(250, 0.05, 2435)
                 .build();

std::shared_ptr<voss::controller::ArcPIDController> arc = voss::controller::ArcPIDControllerBuilder(odom)
               .with_track_width(16)
...
std::shared_ptr<voss::controller::ExitConditions> ec = voss::controller::ExitConditions::new_conditions()
